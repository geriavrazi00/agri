...
(function(h) {
				...
				if (c === k || c === i)
					(j = l[i]),
						...
						j && j._bAttrSrc
							...
							: q ? (j._setter || (j._setter = S(j.mData)), j._setter(d, n)) : (d[i] = n);
				i++;
			};
		if (f)
			for (; f; ) {
			...
			if ('<' == j) {
				...
				if ("'" == n || '"' == n) {
					...
					-1 != l.indexOf('.')
						...
						: '#' == l.charAt(0) ? (i.id = l.substr(1, l.length - 1)) : (i.className = l);
					k += q;
				}
				e.append(i);
				e = h(i);
	...
	t.registerPlural = u = function(a, b, c) {
		...
		t.register(b, function() {
			...
			return a === this
				? this
				: a instanceof t ? (a.length ? (h.isArray(a[0]) ? new t(a.context, a[0]) : a[0]) : k) : a;
		});
	};
	p('tables()', function(a) {
		var b;
