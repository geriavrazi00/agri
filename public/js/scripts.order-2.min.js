...
!(function(a) {
    ...
    a(window).on("load", function() {
        ...
        a(".back-to-top").click(function() {
            return (
                a("html, body").animate({ scrollTop: 0 }, 500, "easeInOutExpo"),
                !1
            );
        }),
    ...
    var e,
        t = 0;
    a(window).on("scroll load", function() {
        100 <= a(window).scrollTop()
            ? a(".navbar").addClass("active")
            : a(".navbar").removeClass("active");
        var o = a(window).scrollTop(),
            l = a(".navbar").height();
        e < (t = o) && l + l < o
            ? a(".navbar").addClass("scrollUp")
            : t < e && !(o <= l) && a(".navbar").removeClass("scrollUp"),
            (e = t);
    }),
        a(".link-scroll").on("click", function(o) {
            var l = a(this);
            a("html, body")
                .stop()
                .animate(
                    { scrollTop: a(l.attr("href")).offset().top - 100 },
                    1e3
                ),
                o.preventDefault();
        });
...
!(function(i) {
    ...
    i(".to-calc").each(function() {
        (e = o(i(".price", this).val())),
            i(".price", this).val(e + " " + n),
            (s = o(i(".sub-sum", this).val())),
            i(".sub-sum", this).val(s + " " + n),
            (c = o(i(".total-sum").val())),
            i(".total-sum").val(c + " " + n);
    }),
        i(".discount").prop("disabled", !0),
        i(".toggle-content")
            .filter(function() {
                return 0 < i(this).find('input[type="checkbox"]').length;
            })
            .off("click"),
        i(".toggle-content")
            .filter(function() {
                return 0 < i(this).find(".discount[disabled]").length;
            })
            .on("click", function() {
                i("#discountInfoModal").modal();
            }),
        i(".to-calc input").keypress(function(t) {
            8 != t.which &&
                isNaN(String.fromCharCode(t.which)) &&
                t.preventDefault();
        }),
        i(".to-calc input").keyup(function() {
            var t = 0;
            i(".to-calc").each(function() {
                (e = o(i(".price", this).val())),
                    (a = o(i(".discount", this).val())),
                    (r = i(".quantity", this).val()),
                    (u = i(".quantity2", this).val()),
                    (s = i(".sub-sum", this).val()),
                    "0" === a
                        ? (s = 1 * e * (1 * r) * (1 * u))
                        : ((s = 1 * e * (1 * r) * (1 * u)),
                          (s -= s * (a = (a / 100) * 1))),
                    0 < r.length && 0 < u.length
                        ? (i(".sub-sum", this).val(l(s) + " " + n), (t += s))
                        : i(".sub-sum", this).val("0 $");
            }),
                i(".total-sum").val(l(t) + " " + n);
        }),
        i(".btn-generate").click(function() {
            i("#inputOrderList").empty(),
                i(".to-calc").each(function() {
                    (t = i(".item-name", this).val()),
                        (e = o(i(".price", this).val()) + " " + n),
                        (r = i(".quantity", this).val()),
                        (u = i(".quantity2", this).val()),
                        (a = o(i(".discount", this).val())),
                        (s = i(".sub-sum", this).val()),
                ...
                i("#inputOrderList").append("TOTAL : " + i(".total-sum").val());
        }),
        i(".btn-reset").click(function() {
            i("#inputOrderList").empty();
        }),
        i("#orderForm").parsley(),
        i("#orderForm").attr("action", "order_send.php"),
        i('a[href^="#"]').click(function(t) {
            t.preventDefault();
            var n = i(i(this).attr("href")).offset().top - 150;
            i("body, html").animate({ scrollTop: n });
        });
})(window.jQuery);
