    ...
    <table id="loaninput" class="resulttable display responsive" style="width: 100%;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <input type="number" id="loan-1-1" name="loan-1-1" class="form-control" oninvalid="createInvalidMsg(this, '{{trans('validation.repayment_period_required')}}', '');" oninput="createInvalidMsg(this, '', '');" onkeydown="return blockSpecialCharactersInInputNumber(event);" placeholder="{{ trans('messages.period_in_years') }}"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="number" id="loan-2-1" name="loan-2-1" class="form-control" oninvalid="createInvalidMsg(this, '{{trans('validation.repayment_period_required')}}', '');" oninput="createInvalidMsg(this, '', '');" onkeydown="return blockSpecialCharactersInInputNumber(event);" placeholder="{{ trans('messages.payments_per_year') }}"/>
                </td>
            </tr>
            <tr>
