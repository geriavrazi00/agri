    ...
    <table id="loaninput" class="resulttable display responsive" style="width: 100%;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <input type="number" id="loan-1" name="loan-1" class="form-control" required oninvalid="createInvalidMsg(this, '{{trans('validation.repayment_period_required')}}', '');" oninput="createInvalidMsg(this, '', '');" onkeydown="return blockSpecialCharactersInInputNumber(event);" placeholder="{{ trans('messages.period_in_years') }}"/>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input type="number" id="loan-2" name="loan-2" class="form-control" required oninvalid="createInvalidMsg(this, '{{trans('validation.repayment_period_required')}}', '');" oninput="createInvalidMsg(this, '', '');" onkeydown="return blockSpecialCharactersInInputNumber(event);" placeholder="{{ trans('messages.payments_per_year') }}"/>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input type='text' id="loan-3" name="loan-3" class="datepicker-here form-control" data-position="right bottom" data-language="sq" required oninvalid="createInvalidMsg(this, '{{trans('validation.first_payment_date_required')}}', '');" oninput="createInvalidMsg(this, '', '');" placeholder="{{ trans('messages.date_of_first_payment') }}"/>
                </td>
                <td>
