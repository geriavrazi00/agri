    ...
    <table id="loaninput" class="resulttable display responsive" style="width: 100%;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <input type="number" id="loan-1-0" name="loan-1-0" class="form-control" required oninvalid="createInvalidMsg(this, '{{trans('validation.repayment_period_required')}}', '');" onmousemove="createInvalidMsg(this, '', '');" onkeydown="return blockSpecialCharactersInInputNumber(event);" placeholder="{{ trans('messages.period_in_years') }}" style="text-align: right"/>
                </td>
                <td>
                    <input type="number" id="loan-1-1" name="loan-1-1" class="form-control" oninvalid="createInvalidMsg(this, '{{trans('validation.repayment_period_required')}}', '');" onmousemove="createInvalidMsg(this, '', '');" onkeydown="return blockSpecialCharactersInInputNumber(event);" placeholder="{{ trans('messages.period_in_years') }}" style="text-align: right"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="number" id="loan-2-1" name="loan-2-1" class="form-control" oninvalid="createInvalidMsg(this, '{{trans('validation.repayment_period_required')}}', '');" onmousemove="createInvalidMsg(this, '', '');" onkeydown="return blockSpecialCharactersInInputNumber(event);" placeholder="{{ trans('messages.payments_per_year') }}" style="text-align: right"/>
                </td>
            </tr>
            <tr>
                <td>{{trans('loan_data.first_payment_date')}}</td>
                <td>
                    <input type='text' id="loan-3-0" name="loan-3-0" class="datepicker-here form-control" data-position="right bottom" data-language="{{ App::getLocale() }}" required oninvalid="createInvalidMsg(this, '{{trans('validation.first_payment_date_required')}}', '');" onmousemove="createInvalidMsg(this, '', '');" placeholder="{{ trans('messages.date_of_first_payment') }}" style="text-align: right;"/>
                </td>
                <td>
