		...
		<div class="col-md-6" style="padding-top: 56px; color: black;">
			...
			<div class="table card-body" style="background-color: white;">
                <div class="form-group row">
                    <label for="name" class="col-md-5 col-form-label text-md-right">Emri</label>
                    <label id="name" class="col-md-7 col-form-label">{{$user->name}}</label>
                </div>

                <div class="form-group row">
                    <label for="email" class="col-md-5 col-form-label text-md-right">Adresa e-mail</label>
                    <label id="email" class="col-md-7 col-form-label">{{$user->email}}</label>
                </div>

                <div class="form-group row">
                    <label for="role" class="col-md-5 col-form-label text-md-right">Roli</label>
                    <label id="role" class="col-md-7 col-form-label">{{$user->role->name}}</label>
                </div>
