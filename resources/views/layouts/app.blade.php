                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item dropdown">
                                    <a aria-expanded="false" aria-haspopup="true" class="nav-link active dropdown-toggle" data-toggle="dropdown" href="" id="pages">Orer Wizard</a>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="order-1.html">Demo 1</a>
                                        <a class="dropdown-item" href="order-2.html">Demo 2</a>
                                        <a class="dropdown-item" href="order-3.html">Demo 3</a>
                                    </div>
                                </li>
                                <!-- Link -->
                                <li class="nav-item">
                            ...
                            <a class="btn btn-primary navbar-btn ml-0 ml-lg-3" href="#">BUY</a>
                        </div>
                    </div>
                </nav>
            </header>
